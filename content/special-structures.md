...
when interesting from the [Chimera modeling system](https://www.cgl.ucsf.edu/chimera/) and the
unreleased `Molbrowser` project.  The parser test PDB files
were the same as those featured in the 20 years of the [PDB-101 Molecule of the Month](https://pdb101.rcsb.org/motm/motm-about)
(_**MotM**_) feature of the [rcsb.org](https://www.rcsb.org/).

## [2r6p](https://www.rcsb.org/structure/2r6p)

This interesting PDB was featured in the July 2008 **_MotM_** article on Dengue Virus.

* [MotM Dengue Virus July 2008](https://pdb101.rcsb.org/motm/103)
...
## [2zoi](https://www.rcsb.org/structure/2zoi)
...
* [MotM Photoactive Yellow Protein March 2017](https://pdb101.rcsb.org/motm/207)
...
## [1znf](https://www.rcsb.org/structure/1ZNF)
...
* [MotM Zinc Fingers March 2007](https://pdb101.rcsb.org/motm/87)
...
for this [1ZNF](https://www.rcsb.org/structure/1ZNF) model where the `CONECT` records define the
